...
def ecran_navigation(fenetre, revenir_callback, fermer_callback):
    ...
    g.bouton_tendance1 = None
    g.bouton_tendance2 = None
    g.bouton_tendance3 = None
    g.bouton_filament1 = None
    g.bouton_filament2 = None
    g.bouton_filament3 = None
    g.bouton_electronique1 = None
    g.bouton_electronique2 = None
    g.btn_valider = None
    ...
    nom_user = g.utilisateur_actuel if g.utilisateur_actuel else "Ami"
    g.titre_nav = ctk.CTkLabel(fenetre, text=f"Bienvenue {nom_user} !", font=("Segoe Print", 15), text_color="black")
    ...
    g.btn_retour = ctk.CTkButton(fenetre, text="Quitter", width=60, height=30, fg_color="#E74C3C", hover_color="#C0392B", command=auto_logout)
